...
- **Table** : Créer une table en Markdown rappelant les sources mobilisées dans l'exercice. 
]
...
Un code **propre** et **fonctionnel** peut être lu et amélioré par un autre auteur.
...
````markdown
`r ''```{r, library_import, warning = FALSE, message = FALSE}
